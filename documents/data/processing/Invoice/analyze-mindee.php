...
[$params, $providers] = eQual::announce([
    ...
    'constants'     => ['ENV_MODE', 'MINDEE_API_KEY'],
    'access' => [
...
// #todo #test - use in testing unit instead
if(constant('ENV_MODE') === 'development' && $document['name'] === 'FACTURES ACP RESIDENCE THEO 4.pdf') {
    $test = true;
    $json = <<<'EOT'
