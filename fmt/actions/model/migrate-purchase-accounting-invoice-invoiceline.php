...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for purchase_accounting_invoice_invoiceline.',
    'params'        => [
        'confirm' => [
...
$table = 'purchase_accounting_invoice_invoiceline';
$reported_rows = 7;
...
$required_columns = ['id', 'model', 'condo_id', 'invoice_id'];
...
$classify = static function(array $row): string {
    return (int) ($row['condo_id'] ?? 0) > 0
            ? 'realestate\\purchase\\accounting\\invoice\\PurchaseInvoiceLine'
            : 'purchase\\accounting\\invoice\\PurchaseInvoiceLine';
};
