...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for finance_accounting_accountingentry.',
    'params'        => [
        'confirm' => [
...
$table = 'finance_accounting_accountingentry';
$reported_rows = 71;
...
$classify = static function(array $row): string {
    return (int) ($row['condo_id'] ?? 0) > 0
            ...
            : 'finance\\accounting\\AccountingEntry';
};
