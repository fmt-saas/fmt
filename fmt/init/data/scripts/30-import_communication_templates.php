...
TemplatePart::create([
    'name'          => 'subject',
    'value'         => '<p style="text-align: center;">Convocation à {type} du {date}</p>',
    'template_id'   => $template['id'],
