...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for core_alert_message.',
    'params'        => [
        'confirm' => [
...
$required_columns = ['id', 'model', 'object_class'];
