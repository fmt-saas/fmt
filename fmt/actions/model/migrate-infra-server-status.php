...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for infra_server_status.',
    'params'        => [
        'confirm' => [
...
$required_columns = ['id', 'model', 'server_id', 'instance_id'];
...
$classify = static function(array $row): string {
    if($row['server_id']) {
        return 'infra\server\ServerStatus';
    }
    if($row['instance_id']) {
        return 'infra\server\InstanceStatus';
    }
    return 'infra\server\Status';
};
