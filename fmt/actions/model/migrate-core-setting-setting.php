...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for core_setting_setting.',
    'params'        => [
        'confirm' => [
...
$required_columns = ['id', 'model', 'type', 'object_class'];
