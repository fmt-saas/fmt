...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for finance_accounting_miscoperation.',
    'params'        => [
        'confirm' => [
...
$table = 'finance_accounting_miscoperation';
$reported_rows = 7;
...
$required_columns = ['id', 'model', 'operation_type'];
...
$classify = static function(array $row): string {
    $models = [
            'misc'     => 'finance\\accounting\\MiscOperation',
            'refund'   => 'realestate\\finance\\accounting\\MoneyRefund',
            'transfer' => 'realestate\\finance\\accounting\\MoneyTransfer',
        ];
