...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for finance_bank_bankaccount.',
    'params'        => [
        'confirm' => [
...
$table = 'finance_bank_bankaccount';
$reported_rows = 144;
...
$required_columns = ['id', 'model', 'object_class', 'bank_account_type'];
...
$classify = static function(array $row): string {
    $models = [
        'finance\\bank\\BankAccount'            => 'finance\\bank\\BankAccount',
        'finance\\bank\\CondominiumBankAccount' => 'finance\\bank\\CondominiumBankAccount',
        'finance\\bank\\OwnershipBankAccount'   => 'finance\\bank\\OwnershipBankAccount',
    ];
