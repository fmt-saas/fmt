...
[$params, $providers] = eQual::announce([
    'description'   => 'Generate a HTML rendering of the given balance sheet ("Dépenses courantes").',
    'params'        => [
        'params' => [
...
$labels = $getLabels(
    $params['lang'],
    sprintf('%s/packages/finance/i18n/%s/accounting/%s.json', EQ_BASEDIR, $params['lang'], 'expenseSummary.'.$params['view_id']),
    [
        'summary.table.th.provider'    => 'Provider',
        'summary.table.th.journal'     => 'JNL',
        'summary.table.th.ref'         => 'Reference',
        'summary.table.th.date'        => 'Date',
        'summary.table.th.description' => 'Description',
        'summary.table.th.tenant'      => 'Tenant',
        'summary.table.th.amount'      => 'Amount',
        'summary.table.footer.td.total'=> 'Total'
    ]
);
