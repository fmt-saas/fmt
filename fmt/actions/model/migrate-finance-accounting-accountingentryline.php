...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for finance_accounting_accountingentryline.',
    'params'        => [
        'confirm' => [
...
$table = 'finance_accounting_accountingentryline';
$reported_rows = 277;
...
$required_columns = ['id', 'model', 'condo_id'];
...
$classify = static function(array $row): string {
    return (int) ($row['condo_id'] ?? 0) > 0
            ? 'realestate\\finance\\accounting\\AccountingEntryLine'
            : 'finance\\accounting\\AccountingEntryLine';
};
