...
class MoneyRefund extends \finance\accounting\MiscOperation {
    ...
    public static function getDescription() {
        return 'A MoneyRefund is a specific type of Miscellaneous Operation designed to generate entries and funding for tracking a transfer between internal bank accounts.';
    }
    ...
    public static function getColumns() {
        ...
        return [
            ...
            'counterpart_bank_account_id' => [
                ...
                'domain'            => [['owner_identity_id', 'in', 'object.ownership_id']]
            ],
