...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_pay_paymentreminder.',
    'params'        => [
        'confirm' => [
...
$table = 'sale_pay_paymentreminder';
$reported_rows = 1;
...
$classify = static function(array $row): string {
    return $row['condo_id'] ? 'realestate\\funding\\PaymentReminder' : 'sale\\pay\\PaymentReminder';
};
