...
$condoWorkingFund = CondoFund::create([
    ...
    ->transition('validate')
    ->read(['fund_account_id'])
    ->first();

$condoReserveFund = CondoFund::create([
...
$fundRequest = FundRequest::create([
        ...
        'fiscal_year_id'            => 1,
        'fiscal_period_id'          => 1,
        'request_type'              => 'working_fund',
        'request_account_id'        => $condoWorkingFund['fund_account_id'],
