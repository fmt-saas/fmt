...
TemplatePart::create([
    'name'          => 'body',
    'value'         => "<p>Bonjour,</p><p><br></p><p>Veuillez trouver en pièce jointe l'appel de {type} concernant la copropriété <strong>{condo}</strong>.</p><p>Le montant est payable pour le <strong>{due_date}</strong>, selon les modalités précisées dans le document annexé.</p><p>Nous vous remercions de votre attention et restons à votre disposition pour toute information complémentaire.</p>",
    'template_id'   => $template['id'],
    'variables'     => '["condo", "due_date", "type"]'
]);
...
TemplatePart::create([
    'name'          => 'introduction',
    'value'         => "<p>Bonjour,</p><p><br></p><p>Veuillez trouver en pièce jointe l'appel de fonds concernant la copropriété <strong>{condo}</strong> pour la période <strong>{period}</strong>.</p><p>Le montant est payable pour le <strong>{due_date}</strong>, selon les modalités précisées dans le document annexé.</p><p><br></p><p>Nous vous remercions de votre attention et restons à votre disposition pour toute information complémentaire.</p>",
    'template_id'   => $template['id'],
...
$template = Template::create([
        ...
        'description'   => "Dossier de mutation - paragraphe 1",
        'category_id'   => 5,
        'type_id'       => 5
    ])
    ->read(['id'])
