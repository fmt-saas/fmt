...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_pay_funding.',
    'params'        => [
        'confirm' => [
...
$required_columns = ['id', 'model', 'condo_id', 'funding_type'];
