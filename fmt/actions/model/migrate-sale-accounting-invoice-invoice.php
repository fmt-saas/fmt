...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for sale_accounting_invoice_invoice.',
    'params'        => [
        'confirm' => [
...
$table = 'sale_accounting_invoice_invoice';
$reported_rows = 21;
...
$required_columns = ['id', 'model', 'invoice_type'];
...
$classify = static function(array $row): string {
    $models = [
            'expense_statement' => 'realestate\\funding\\ExpenseStatement',
            'fund_request'      => 'realestate\\funding\\FundRequestExecution',
            'invoice'           => 'realestate\\sale\\accounting\\invoice\\SaleInvoice',
            'credit_note'       => 'realestate\\sale\\accounting\\invoice\\SaleInvoice',
        ];
