...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for realestate_property_ownershiptransferattachment.',
    'params'        => [
        'confirm' => [
...
$table = 'realestate_property_ownershiptransferattachment';
$reported_rows = 1;
...
$required_columns = ['id', 'model', 'attachment_section'];
...
$classify = static function(array $row): string {
    $models = [
            'all'                      => 'realestate\\property\\OwnershipTransferAttachmentAll',
            'balance_sheet'            => 'realestate\\property\\OwnershipTransferAttachmentBalanceSheet',
            'expense_statement'        => 'realestate\\property\\OwnershipTransferAttachmentExpenseStatement',
            'general_assembly_minutes' => 'realestate\\property\\OwnershipTransferAttachmentGeneralAssemblyMinutes',
        ];
