...
[$params, $providers] = eQual::announce([
    'description'   => 'Migrate the model discriminator for purchase_supplier_supplier.',
    'params'        => [
        'confirm' => [
...
$required_columns = ['id', 'model', 'object_class', 'type', 'supplier_type_code'];
...
$classify = static function(array $row): string {
    $models = [
            'finance\\bank\\Bank'                    => 'finance\\bank\\Bank',
            'purchase\\supplier\\Supplier'           => 'purchase\\supplier\\Supplier',
            'realestate\\management\\ManagingAgent'  => 'realestate\\management\\ManagingAgent',
