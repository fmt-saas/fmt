...
class PurchaseInvoice extends \purchase\accounting\invoice\PurchaseInvoice {
    ...
    public static function canupdate($self, $values) {
        ...
        foreach($self as $id => $invoice) {
            $allowed_fields = [
                    'status', 'alert', 'name', 'price', 'total', 'document_process_status', 'assigned_employee_id', 'invoice_number', 'payment_status',
                    'has_payment_on_hold', 'has_mandate', 'customer_ref', 'funding_id', 'accounting_entry_id', 'reversed_invoice_id'
                ];
